...
//TODO remove unused old code after testing
// const labelColors = [
//   Colors.brown,
//   Colors.cyan,
//   Colors.green,
...
//   Colors.orange
// ];
// List<Color> labelColors = List.generate(
//   6,(index) => Color((Random().nextDouble() * 0xFFFFFF).toInt() << 0).withOpacity(1.0),
// );

// optimized color generator
